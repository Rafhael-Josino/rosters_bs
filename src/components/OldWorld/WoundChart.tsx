        ...
        <table className='wound-chart-table' style={{margin:'0'}}>
          <tbody>
            ...
            <tr>
              ...
              <td className={selectedCellClass(1,3,false)}>6+</td>
              <td className={selectedCellClass(1,4,false)}>6+</td>
              <td className={selectedCellClass(1,5,false)}>6+</td>
              <td className={selectedCellClass(1,6,false)}>6+</td>
              <td className={selectedCellClass(1,7,false)}>--</td>
              <td className={selectedCellClass(1,8,false)}>--</td>
            ...
            <tr>
              ...
              <td className={selectedCellClass(2,4,true)}>6+</td>
              <td className={selectedCellClass(2,5,true)}>6+</td>
              <td className={selectedCellClass(2,6,true)}>6+</td>
              <td className={selectedCellClass(2,7,true)}>6+</td>
              <td className={selectedCellClass(2,8,true)}>--</td>
              <td className={selectedCellClass(2,9,true)}>--</td>
            ...
            <tr>
              ...
              <td className={selectedCellClass(3,5,false)}>6+</td>
              <td className={selectedCellClass(3,6,false)}>6+</td>
              <td className={selectedCellClass(3,7,false)}>6+</td>
              <td className={selectedCellClass(3,8,false)}>6+</td>
              <td className={selectedCellClass(3,9,false)}>--</td>
              <td className={selectedCellClass(3,10,false)}>--</td>
            </tr>

            <tr>
              <td className='header-table' onClick={() => setSelectedRow(4)}>4</td>
              <td className={selectedCellClass(4,1,true)}>2+</td>
              <td className={selectedCellClass(4,2,true)}>2+</td>
              ...
              <td className={selectedCellClass(4,6,true)}>6+</td>
              <td className={selectedCellClass(4,7,true)}>6+</td>
              <td className={selectedCellClass(4,8,true)}>6+</td>
              <td className={selectedCellClass(4,9,true)}>6+</td>
              <td className={selectedCellClass(4,10,true)}>--</td>
            </tr>
            ...
            <tr>
              ...
              <td className={selectedCellClass(5,3,false)}>2+</td>
              ...
              <td className={selectedCellClass(5,7,false)}>6+</td>
              <td className={selectedCellClass(5,8,false)}>6+</td>
              <td className={selectedCellClass(5,9,false)}>6+</td>
              <td className={selectedCellClass(5,10,false)}>6+</td>
            </tr>
            ...
            <tr>
              ...
              <td className={selectedCellClass(6,3,true)}>2+</td>
              <td className={selectedCellClass(6,4,true)}>2+</td>
              ...
              <td className={selectedCellClass(6,8,true)}>6+</td>
            ...
            <tr>
              ...
              <td className={selectedCellClass(7,4,false)}>2+</td>
              <td className={selectedCellClass(7,5,false)}>2+</td>
              ...
              <td className={selectedCellClass(7,9,false)}>6+</td>
            ...
            <tr>
              ...
              <td className={selectedCellClass(8,4,true)}>2+</td>
              <td className={selectedCellClass(8,5,true)}>2+</td>
              <td className={selectedCellClass(8,6,true)}>2+</td>
              ...
              <td className={selectedCellClass(8,10,true)}>6+</td>
            </tr>
            ...
            <tr>
              ...
              <td className={selectedCellClass(9,5,false)}>2+</td>
              <td className={selectedCellClass(9,6,false)}>2+</td>
              <td className={selectedCellClass(9,7,false)}>2+</td>
            ...
            <tr>
              ...
              <td className={selectedCellClass(10,5,true)}>2+</td>
              <td className={selectedCellClass(10,6,true)}>2+</td>
              <td className={selectedCellClass(10,7,true)}>2+</td>
              <td className={selectedCellClass(10,8,true)}>2+</td>
