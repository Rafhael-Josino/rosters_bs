...
function Home () {
  ...
  const [showStrPloy, setShowStrPloy] = useState(true);
  const [showTacPloy, setShowTacPloy] = useState(true);
  ...
  const showAbilityHandler = () => {
    const showAbilityTmp = !showAbility;
    setShowAbility(showAbilityTmp);
  }

  const showStrPloyHandler = () => {
    const showStrPloyTmp = !showStrPloy;
    setShowStrPloy(showStrPloyTmp);
  }

  const showTacPloyHandler = () => {
    const showTacPloyTmp = !showTacPloy;
    setShowTacPloy(showTacPloyTmp);
  }
  ...
  const AbilitiesSection: JSX.Element = <section>
  ...
  const StrPloysSection: JSX.Element = <section>
    <div className='faction_box'>
  ...
  const TacPloysSection: JSX.Element = <section>
    <div className='faction_box'>
  ...
  return <div>
    ...
    <div className='battlescribe'>
      ...
      <div className="summary battlescribe">
        <div className='faction_header'>
          <span>FACTION ABILITIES</span>
          <button onClick={showAbilityHandler}>
            {showAbility? <GiCardboardBox /> : <GiCardboardBoxClosed />}
          </button>
        </div>
        {showAbility? AbilitiesSection : <section>...</section>}
      </div>

      <div className="summary battlescribe">
        <div className='faction_header'>
          <span>STRATEGIC PLOYS</span>
          <button onClick={showStrPloyHandler}>
            {showStrPloy? <GiCardboardBox /> : <GiCardboardBoxClosed />}
          </button>
        </div>
        {showStrPloy? StrPloysSection : <section>...</section>}
      </div>
      
      <div className="summary battlescribe">
        <div className='faction_header'>
          <span>TACTICAL PLOYS</span>
          <button onClick={showTacPloyHandler}>
            {showTacPloy? <GiCardboardBox /> : <GiCardboardBoxClosed />}
          </button>
        </div>
        {showTacPloy? TacPloysSection : <section>...</section>}
      </div>
    </div>
  </div>
}
